                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="role"><g:message code="role.role.label" default="Role" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: roleInstance, field: 'role', 'errors')}">
                                    <g:select name="idRole" from="${admin.Role.list()}" optionKey="id" optionValue="authority" value="${roleInstance?.authority}"  />
                                </td>
                            </tr>
