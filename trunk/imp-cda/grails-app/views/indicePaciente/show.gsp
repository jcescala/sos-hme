            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="indicePaciente.id.label" default="Id" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: indicePacienteInstance, field: "id")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="indicePaciente.pacientes.label" default="Pacientes" /></td>
