...
public interface ImpServicePortType {
    ...
    @WebResult(name = "return", targetNamespace = "")
    @RequestWrapper(localName = "obtenerImagenPaciente", targetNamespace = "http://imp/", className = "imp.ObtenerImagenPaciente")
    @WebMethod
    @ResponseWrapper(localName = "obtenerImagenPacienteResponse", targetNamespace = "http://imp/", className = "imp.ObtenerImagenPacienteResponse")
    public java.lang.String obtenerImagenPaciente();
